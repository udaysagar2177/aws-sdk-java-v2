...
import static software.amazon.awssdk.services.s3.checksums.ChecksumsEnabledValidator.trailingChecksumsEnabledFromConfig;
...
public final class EnableTrailingChecksumInterceptor implements ExecutionInterceptor {
    ...
    /**
     * Appending trailing checksum header for {@link GetObjectRequest} if trailing checksum is enabled from config.
     */
    @Override
    public SdkHttpRequest modifyHttpRequest(Context.ModifyHttpRequest context,
                                            ExecutionAttributes executionAttributes) {

        if (context.request() instanceof GetObjectRequest && trailingChecksumsEnabledFromConfig(executionAttributes)) {
    ...
    public SdkResponse modifyResponse(Context.ModifyResponse context, ExecutionAttributes executionAttributes) {
        ...
        if (response instanceof GetObjectResponse && getObjectTrailingChecksumsEnabled(httpResponse)) {
