...
public class EnableTrailingChecksumInterceptorTest {
    ...
    @Test
    public void getObjectTrailingChecksumEnabled_shouldAddTrailingChecksumHeader() {
    ...
    @Test
    public void getObjectTrailingChecksumDisabled_shouldNotModifyHttpRequest() {
        Context.ModifyHttpRequest modifyHttpRequestContext =
            modifyHttpRequestContext(GetObjectRequest.builder().build());
    ...
    @Test
    public void nonGetObjectRequest_shouldNotModifyHttpRequest() {
        Context.ModifyHttpRequest modifyHttpRequestContext =
    ...
    @Test
    public void getObjectResponse_containsChecksumHeader_shouldModifyResponse() {
        long contentLength = 50;
        GetObjectResponse response = GetObjectResponse.builder().contentLength(contentLength).build();
        Context.ModifyResponse modifyResponseContext = modifyResponseContext(response,
    ...
    @Test
    public void getObjectResponse_noChecksumHeader_shouldNotModifyResponse() {
        long contentLength = 50;
        GetObjectResponse response = GetObjectResponse.builder().contentLength(contentLength).build();
        Context.ModifyResponse modifyResponseContext = modifyResponseContext(response,
    ...
    @Test
    public void nonGetObjectResponse_shouldNotModifyResponse() {
        GetObjectAclResponse getObjectAclResponse = GetObjectAclResponse.builder().build();
        Context.ModifyResponse modifyResponseContext = modifyResponseContext(getObjectAclResponse,
                                                                             SdkHttpFullResponse.builder().build());
